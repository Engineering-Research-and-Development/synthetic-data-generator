...
class CreateAlgorithm(BaseModel):
    ...
    description: str = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
                         examples=["A description of an algorithm"])
    default_loss_function: str = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
...
class AllowedDataType(BaseModel):
    id : PositiveInt
    algorithm_name : str  = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
                         examples=["The name of analgorithm"])
    data_type : str  = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
...
class CreateTrainedModel(BaseModel):
    ...
    dataset_name: str  = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
                         examples=["The name of a dataset"])
    size: str  = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
...
class Features(BaseModel):
    id : PositiveInt
    feature_name : str = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
...
class CreateTrainingInfo(BaseModel):
    loss_function : str = Field(pattern="^[^ ](.*[^ ])?$",
                         description="This field does NOT allow strings that"
                                     " start or end with spaces or are empty",
...
class TrainedModelAndVersions(TrainedModel):
    versions: list[ModelVersionAndTrainInfo] | list[ModelVersion] | None = Field(description="This is a list of the trained model"
